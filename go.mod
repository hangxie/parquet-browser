module github.com/hangxie/parquet-browser
...
require (
	...
	github.com/hangxie/parquet-go/v3 v3.1.2
	github.com/hangxie/parquet-tools v1.49.4
...
require (
	...
	google.golang.org/genproto v0.0.0-20260522204824-7f3bc5b78da9 // indirect
